...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 23, 2014 at 12:09 PM
...
('addimage', 0, NULL, NULL, NULL, NULL, NULL),
('addproduct', 0, NULL, NULL, NULL, NULL, NULL),
('addvendor', 0, NULL, NULL, NULL, NULL, NULL),
('manageproducts', 1, 'can manage products', NULL, NULL, NULL, NULL),
('managesuppliers', 1, 'can manage suppliers', NULL, NULL, NULL, NULL),
('productmanager', 2, '', NULL, NULL, NULL, NULL),
('superadmin', 2, 'God', NULL, NULL, NULL, NULL),
('supplymanager', 2, NULL, NULL, NULL, NULL, NULL),
...
('manageproducts', 'addimage'),
('manageproducts', 'addproduct'),
('managesuppliers', 'addvendor'),
('productmanager', 'manageproducts'),
('supplymanager', 'managesuppliers'),
('superadmin', 'productmanager'),
('superadmin', 'supplymanager'),
('superadmin', 'user');
...
CREATE TABLE IF NOT EXISTS `failedtransactions` (
  `FailedTransactionId` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `paymenttransactions` (
  ...
  `ResponseErrorMsg` text,
  `ResponseSysErrMsg` text,
  `RequestMode` text,
  `RequestChannelcode` text,
  `RequestVersion` text,
  `RequestProvUserId` text,
  `UserId` text,
  `RequestId` text,
  `RequestMerchantId` text,
  `RequestTransactionType` text,
  `RequestMotoInd` text,
...
INSERT INTO `productcategories` (`ProductCategoryId`, `ParentProductCategoryId`, `Name`, `Description`, `ShortDescription`, `HtmlDecription`, `AvatarUrl`, `IconUrl`, `Comment`, `LastUpdatedBy`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 0, 'Electronic', NULL, NULL, NULL, NULL, NULL, NULL, 1, 2147483647, 2147483647, NULL);
...
--
-- Dumping data for table `productoptioncombinations`
--

INSERT INTO `productoptioncombinations` (`ProductOptionCombinationId`, `ProductId`, `ProductOptionGroupMemberId1`, `ProductOptionGroupMemberId2`, `ProductOptionGroupMemberId3`, `ProductOptionGroupMemberId4`, `ProductOptionGroupMemberId5`, `Barcode`, `Price`, `PriceMarket`, `PriceSupplier`, `CampaignStock`, `ActualStock`, `StockWarningLevel`, `StockUnitId`, `Comment`, `UpdatedBy`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 1, 9, 6, 1, NULL, NULL, '333100906010', '2000.00', '2500.00', '1600.00', '100.00', '0.00', NULL, 1, NULL, 1, 1406134761, 1406134761, NULL),
(2, 1, 8, 7, 3, NULL, NULL, '333100807030', '1500.00', '2000.00', '900.00', '80.00', '10.00', NULL, 1, NULL, 1, 1406134786, 1406134786, NULL);
...
--
-- Dumping data for table `productoptiongroupmembers`
--

INSERT INTO `productoptiongroupmembers` (`ProductOptionGroupMemberId`, `ProductOptionGroupId`, `Name`, `DisplayOrder`, `Comment`, `LastUpdatedBy`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 1, '8 GB', 1, NULL, 1, 1406134206, 1406134206, NULL),
(2, 1, '16 GB', 2, NULL, 1, 1406134231, 1406134231, NULL),
(3, 1, '32 GB', 3, NULL, 1, 1406134254, 1406134254, NULL),
(4, 1, '64 GB', 4, NULL, 1, 1406134267, 1406134267, NULL),
(5, 2, 'WiFi', 1, NULL, 1, 1406134284, 1406134284, NULL),
(6, 2, '3G', 2, NULL, 1, 1406134306, 1406134306, NULL),
(7, 2, 'Edge', 3, NULL, 1, 1406134318, 1406134318, NULL),
(8, 3, '3 Gen', 1, NULL, 1, 1406134337, 1406134337, NULL),
(9, 3, '4 Gen', 2, NULL, 1, 1406134351, 1406134351, NULL),
(10, 3, '5 Gen', 3, NULL, 1, 1406134372, 1406134372, NULL);
...
--
-- Dumping data for table `productoptiongroups`
--

INSERT INTO `productoptiongroups` (`ProductOptionGroupId`, `Name`, `DisplayOrder`, `Comment`, `LastUpdatedBy`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 'Memory', 1, NULL, 1, 1406134130, 1406134130, NULL),
(2, 'Connection', 2, NULL, 1, 1406134158, 1406134158, NULL),
(3, 'Model', 2, NULL, 1, 1406134180, 1406134180, NULL);
...
INSERT INTO `productoptions` (`ProductOptionId`, `ProductId`, `ProductOptionGroupId`, `ProductOptionGroupMemberId`, `Value`, `Comment`, `LastUpdatedBy`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 1, 1, 1, NULL, NULL, 1, 1406134445, 1406134445, NULL),
(2, 1, 1, 2, NULL, NULL, 1, 1406134463, 1406134463, NULL),
(3, 1, 1, 3, NULL, NULL, 1, 1406134483, 1406134483, NULL),
(4, 1, 1, 4, NULL, NULL, 1, 1406134499, 1406134499, NULL),
(5, 1, 2, 5, NULL, NULL, 1, 1406134543, 1406134543, NULL),
(6, 1, 2, 6, NULL, NULL, 1, 1406134562, 1406134562, NULL),
(7, 1, 2, 7, NULL, NULL, 1, 1406134664, 1406134664, NULL),
(8, 1, 3, 8, NULL, NULL, 1, 1406134689, 1406134689, NULL),
(9, 1, 3, 9, NULL, NULL, 1, 1406134703, 1406134703, NULL),
(10, 1, 3, 10, NULL, NULL, 1, 1406134726, 1406134726, NULL);
...
CREATE TABLE IF NOT EXISTS `productpricehistories` (
  ...
  KEY `ProductOptionPriceId` (`ProductOptionPriceId`),
...
INSERT INTO `products` (`ProductId`, `ProductCategoryId`, `SupplierId`, `BrandId`, `ProductTypeId`, `Gender`, `Name`, `SupplierDescription`, `Description`, `ShortDescriptioon`, `HtmlDescription`, `UrlName`, `DiscountPercent`, `CommissionPercent`, `TaxPercent`, `Price`, `PriceMarket`, `PriceSupplier`, `MaximumPurchaseCount`, `IsActive`, `IsFeatured`, `IsOnVote`, `VoteCount`, `Comment`, `LastModifiedBy`, `PublishedOn`, `updated_at`, `created_at`, `deleted_at`) VALUES
(1, 1, NULL, NULL, 1, 'a', 'iPhone', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, 1406134393, 1406134393, NULL);
...
INSERT INTO `producttypes` (`ProductTypeId`, `ProductCategoryId`, `Name`, `Comment`, `LastUpdatedBy`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 1, 'Smart Phone', NULL, 1, 1406134085, 1406134085, NULL),
(2, 1, 'Laptop', NULL, 1, 1406134105, 1406134105, NULL);
...
CREATE TABLE IF NOT EXISTS `refundtransactions` (
  `RefundTransactionId` int(11) NOT NULL DEFAULT '0',
  `OrderId` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `stockunits`
--

INSERT INTO `stockunits` (`StockUnitId`, `Name`, `Comment`, `LastUpdatedBy`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 'Item', NULL, 1, 1406134409, 1406134409, NULL),
(2, 'Liter', NULL, 1, 1406134421, 1406134421, NULL);
...
CREATE TABLE IF NOT EXISTS `suppliersbrands` (
  ...
  `SupplierId` int(11) DEFAULT NULL,
  `Comment` text,
  `LastUpdatedBy` char(10) DEFAULT NULL,
  `created_at` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `IsLikedFanPage` bit(1) DEFAULT NULL,
  `PhotoUrl` varchar(1000) DEFAULT NULL,
  `IsPersonal` bit(1) DEFAULT NULL,
  `IdentityNumber` char(11) DEFAULT NULL,
  ...
  `previousLogin` int(11) DEFAULT NULL,
  `LastUpdatedBy` int(11) DEFAULT NULL,
  `created_at` int(11) NOT NULL,
  `updated_at` int(11) NOT NULL,
  `deleted_at` int(11) DEFAULT NULL,
...
INSERT INTO `users` (`UserId`, `UserTypeId`, `username`, `auth_key`, `password_hash`, `password_reset_token`, `email`, `Names`, `PreferredName`, `Surname`, `Gender`, `Birthday`, `Website`, `FacebookId`, `TwitterId`, `IsLikedFanPage`, `PhotoUrl`, `IsPersonal`, `IdentityNumber`, `TaxNumber`, `TaxOffice`, `Comment`, `role`, `status`, `lastLogin`, `previousLogin`, `LastUpdatedBy`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, NULL, 'admin', 'aEi66spBVjql397mdOWanS4WCWgCK1mK', '$2y$13$E556hiBD1ifCW5YEBo6eDeMfSfWZ6e0rvl69DHPDpiT14AB6cBoFa', NULL, 'tom@tskmatrix.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 10, 10, 1402858285, NULL, NULL, 1402167981, 1402850693, NULL),
(2, NULL, 'demo', 'bYKalqY57DPmeaZqS7blFrqUPzc7Mcgc', '$2y$13$wF6WibJseUfsfL.lMWjyFOtMG0dVWJ5V/TKhr5Gz97ArEyav9V3BC', NULL, 'demo@demo.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 10, 10, 1402859906, NULL, NULL, 1402853282, 1402853282, NULL);
...
ALTER TABLE `addresses`
  ...
  ADD CONSTRAINT `FK_Addresses_Users` FOREIGN KEY (`UserId`) REFERENCES `users` (`UserId`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `logs`
  ...
  ADD CONSTRAINT `FK_Logs_Users` FOREIGN KEY (`UserId`) REFERENCES `users` (`UserId`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `phones`
  ADD CONSTRAINT `FK_Phones_Users` FOREIGN KEY (`UserId`) REFERENCES `users` (`UserId`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `userrestdata`
  ADD CONSTRAINT `FK_UserRestData_Users` FOREIGN KEY (`UserId`) REFERENCES `users` (`UserId`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `users`
--
ALTER TABLE `users`
  ADD CONSTRAINT `FK_Users_UserTypes` FOREIGN KEY (`UserTypeId`) REFERENCES `usertypes` (`UserTypeId`) ON DELETE NO ACTION ON UPDATE NO ACTION;
