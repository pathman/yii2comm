...
class Products extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['ProductCategoryId', 'SupplierId', 'BrandId', 'ProductTypeId', 'DiscountPercent', 'CommissionPercent', 'MaximumPurchaseCount', 'VoteCount', 'LastModifiedBy', 'PublishedOn', 'updated_at', 'created_at', 'deleted_at'], 'integer'],
